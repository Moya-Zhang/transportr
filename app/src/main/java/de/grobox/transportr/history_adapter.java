...
public class history_adapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.bt2 = (Button) view.findViewById(R.id.item_btn_bookmark);
        ...
        viewHolder.bt2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                mOnItemBookmarkListener.onBookmarkClick(i);
            }
        });
    ...
    private onItemBookmarkListener mOnItemBookmarkListener;
    private onItemShareListener mOnItemShareListener;

    public void setOnItemDeleteClickListener(onItemDeleteListener mOnItemDeleteListener) {
        this.mOnItemDeleteListener = mOnItemDeleteListener;
    }
    public void setmOnItemBookmarkListener(onItemBookmarkListener mOnItemBookmarkListener){
        this.mOnItemBookmarkListener=mOnItemBookmarkListener;
    }
